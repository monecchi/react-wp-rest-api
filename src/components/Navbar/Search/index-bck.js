...
const NavbarSearchNew = ({...props}) => {
    ...
    return (
        <div className="search-input">
            <form className="search-input__form" onSubmit={e => handleSubmit(e)}>
                <div className="search-input__field-wrapper">
                    ...
                    {/* display the clear button if the search query length is greater than 1 character */}
                ...
                <ul className="search-targeted__options">
                    { searchlist && searchlist.map((item, index) => (
                        <li className="search-targeted__option" key={index}>
                            <button type="button" role="button" className="btn btn--link btn--size-m btn--targeted-search" variant="btn--targeted-search" theme="link" color="primary">
...
NavbarSearchNew.propTypes = {
    suggestions: PropTypes.instanceOf(Array)
};

NavbarSearchNew.defaultProps = {
    suggestions: []
};

export default NavbarSearchNew;

export class SearchInputNew extends Component {
    constructor(props) {
        super(props);
        this.state = {
            query: "",
